...
| Skill | Description |
|-------|-------------|
| [`nice-insights-metrics`](./nice-insights-metrics) | Query ecommerce metrics: ad spend, manually supplied sales, orders, margins, CAC, retention/LTV, current inventory, product traffic, checkout funnel, and email activity |
